...
\begin{document}      
	...
	\newline
	\item[--] Planning : \\ 
	1 mois d'\'etude : Quels sont les acteurs, payant/gratuit, les technos utilis\'ees, le prix, comment peut-on faire la même chose. Nous devons donc \'etudier la concurrence et d\'efinir la/les meilleurs outils, infra (exemple : IBM, Google). L'objectif est de trouver entre 5 et 10 solutions en d\'etaillant l'infra, les supports, les co\^uts macros. 
	...
	%ici le texte 
\medskip
\large\textbf{ R\'eunion interm\'ediaire du 11/10/2016}

%\underline{\large \textbf{A faire pour la prochaine fois}}
	\smallskip \newline 
	D\'ebriefing de la r\'eunion avec l'entreprise, Discussion des diff\'erentes solutions techniques possibles en fonction des besoins d'ACENSI (en respectant les 3V).\\
	Mise en place du planning et du compte rendu de reunion.
	\newline
	Langages que l'on utilisera probablement lors de ce projet : Java, Python , R.
	\newline
	Evaluer les diff\'erentes possibilit\'es de BigData pour quel type d'usage ( Rapidit\'e, Stockage ou les diff\'erents types de donn\'ees).
	...
	\newline
	\item[--] Court terme : \\ 
	Finir le document relatant de l'analyse et du planning co:plet du projet entier tout en se r\'epartissant \'quitablement le travail
	\newline
	\item[--] Moyen Terme \\ 
	Continuer l'\'etude du projet ,du sujet et des solutions possibles de BigData. 
	\end{itemize}
	\end{itemize}

	
	La prochaine r\'eunion se fera le mardi 18 octobre avec Benoit th\'eoriquement, dans la matin\'ee. 
%ici le texte 	\\
